...
\begin{figure}[h]
    \centering{\includegraphics[width=8cm]{images/er_fallos.png}}
    \caption{Robustez frente a fallos en el modelo de Erdős-Rényi}
\end{figure}

\begin{figure}[h]
    \centering{\includegraphics[width=8cm]{images/ba_fallos.png}}
    \caption{Robustez frente a fallos en el modelo de Barabási-Albert}
\end{figure}

\begin{figure}[h]
    \centering{\includegraphics[width=8cm]{images/ws_fallos.png}}
...
\begin{figure}[h]
    \centering{\includegraphics[width=8cm]{images/er_ataques.png}}
    \caption{Robustez frente a ataques en el modelo de Erdős-Rényi}
\end{figure}

\begin{figure}[h]
    \centering{\includegraphics[width=8cm]{images/ba_ataques.png}}
    \caption{Robustez frente a ataques en el modelo de Barabási-Albert}
\end{figure}

\begin{figure}[h]
    \centering{\includegraphics[width=8cm]{images/ws_ataques.png}}
